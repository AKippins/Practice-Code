...
var grid = [[08, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 08],   //#0
...
for (var y = 0; y <= 19; y++){
    for (var x = 0; x <= 16; x++){
        var chain = grid[y][x] * grid[y][x+1] * grid[y][x+2] * grid[y][x+3];
        if (chain > high){
            high = chain;
        }
    }
...
for (var y = 0; y <= 16; y++){
    for (var x = 0; x <= 16; x++){
        var chain = grid[y][x] * grid[y+1][x+1] * grid[y+2][x+2] * grid[y+3][x+3];
        if (chain > high){
            high = chain;
        }
    }
...
for (var y = 0; y <= 16; y++){
    for (var x = 0; x <= 16; x++){
        var chain = grid[y][x+3] * grid[y+1][x+2] * grid[y+2][x+1] * grid[y+3][x];
        if (chain > high){
            high = chain;
        }
    }
